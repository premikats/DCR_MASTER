function [Md,Td,beta,PR,TPR,TR,AR] = TPG_OSW_BLS(Mu,Tu,theta,R)
...
%for a thermally perfect gas. It also considers Booundary layer separation
%criteria i.e. Md/Mu>0.898
...
%     end    
    ...
    beta=beta*180/pi;
    if (Md/Mu<0.898)
        disp('There is Boundary layer separation')
       Md=0;
       Td=0;
       beta=0;
       PR=0;
